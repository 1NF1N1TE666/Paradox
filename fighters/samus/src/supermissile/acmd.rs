...
unsafe extern "C" fn game_ready(agent: &mut L2CAgentBase) {
    ...
    let angle = VarModule::get_float(boma.get_owner_boma().object(), vars::samus::instance::AIM_ANGLE);
    if is_excute(agent) {
