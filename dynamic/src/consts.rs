...
pub mod vars {
    ...
    pub mod brave {
        pub mod instance {
            ...
            pub const LEVEL_UP_EFFECT_LOCK_A: i32 = 0x0101;
            pub const LEVEL_UP_EFFECT_LOCK_B: i32 = 0x0102;
    ...
    pub mod kirby {
        pub mod instance {
            ...
            pub use super::super::ridley::instance::SPECIAL_N_ATTACK;
    ...
    pub mod krool {
        pub mod instance {
            ...
            pub const WAIST_SHIELD: i32 = 0x01D0;
